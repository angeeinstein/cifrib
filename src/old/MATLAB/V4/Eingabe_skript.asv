classdef Eingabe_skript < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        ButtonMomentengelenk       matlab.ui.control.ToggleButton
        ButtonNormalgelenk         matlab.ui.control.ToggleButton
        ButtonQuergelenk           matlab.ui.control.ToggleButton
    ...
    methods (Access = public)
        ...
        function createComponents(app)
            ...
            app.Panel.Position = [1 1 640 440];
            ...
            app.CalculateButton.ButtonPushedFcn = @(~, ~) CalculateButtonPushed(app);
             ...
             % Create BackButton
            app.BackButton = uibutton(app.ParametersPanel, 'push');
            app.BackButton.Position = [48 5 71 23];
            app.BackButton.Text = 'Back';
            app.BackButton.ButtonPushedFcn = @(~, ~) BackButtonPushed(app);
            ...
            app.ButtonLoslager.Position = [5 49 70 39];
            ...
            app.ButtonFestlager.Position = [78 49 70 39];
            ...
            app.ButtonEinspannung.Position = [5 7 70 39];

            % Create ButtonMomentengelenk
            app.ButtonMomentengelenk = uitogglebutton(app.ButtonGroupLager,"Icon","hinge.png","IconAlignment","top");
            app.ButtonMomentengelenk.Icon = "hinge.png";
            app.ButtonMomentengelenk.Text = '';
            app.ButtonMomentengelenk.Position = [78 7 70 39];

            % Create ButtonNormalgelenk
            app.ButtonNormalgelenk = uitogglebutton(app.ButtonGroupLager,"Icon","hinge.png","IconAlignment","top");
            app.ButtonNormalgelenk.Icon = "hinge.png";
            app.ButtonNormalgelenk.Text = 'Normalkraftgelenk';
            app.ButtonNormalgelenk.Position = [5 91 70 39];

            % Create ButtonQuergelenk
            app.ButtonQuergelenk = uitogglebutton(app.ButtonGroupLager,"Icon","hinge.png","IconAlignment","top");
            app.ButtonQuergelenk.Icon = "hinge.png";
            app.ButtonQuergelenk.Text = 'Querkraftgelenk';
            app.ButtonQuergelenk.Position = [78 91 70 39];
            ...
            app.PositionmEditField_2Label.Position = [1 30 74 22];
            ...
            app.PositionmEditField_2.Position = [83 30 64 22];
            ...
            app.StartheightEditFieldLabel.Text = '[Start Value]';
            ...
            app.Label.Position = [0 462 641 18];
            ...
            app.HelpButton.Position = [5 442 71 19];
            app.HelpButton.FontSize = 11;
            app.HelpButton.Text = 'Help';
            app.HelpButton.ButtonPushedFcn = @(btn,event) HelpCallback(app);

            % Create AboutButton
            app.AboutButton = uibutton(app.UIFigure, 'push');
            app.AboutButton.VerticalAlignment = 'top';
            app.AboutButton.Position = [81 442 71 19];
            app.AboutButton.FontSize = 11;
            app.AboutButton.Text = 'About'; 
            app.AboutButton.ButtonPushedFcn = @(btn,event) AboutCallback(app);

            % Create Image
            app.Image = uiimage(app.Panel);
            app.Image.Position = [25 340 100 100];
            app.Image.ImageSource = fullfile('koord_system_cropped.png');
 ...
 % Callbacks that handle component events
   ...
   methods (Access = private)
        ...
        * clampedsupportscale;
            ...
            %Momentengelenk
            if app.ButtonMomentengelenk.Value == true
                %Graphische Darstellung
                ...
                %Einbinden in die structure
                AddJoint(momentjoint1_pos, 1, 1, 0)

            end

           if app.ButtonNormalgelenk.Value == true
            %Graphische Darstellung
            momentjoint1_pos = app.PositionmEditField_2.Value; 
            momentjoint1scale = (app.barlengthmEditField.Value/60);   % size of the joint = 1/60 of bar length
            MomentJoint1X = [0 1 (0.866) (0.5) 0 (-0.5) (-0.866) (-1) (-0.866) (-0.5) 0 (0.5) (0.866) 1] * momentjoint1scale;
            ...
            %Einbinden in die structure
            AddJoint(momentjoint1_pos, 0, 1, 1)

           end

           if app.ButtonQuergelenk.Value == true
            %Graphische Darstellung
            momentjoint1_pos = app.PositionmEditField_2.Value; 
            momentjoint1scale = (app.barlengthmEditField.Value/60);   % size of the joint = 1/60 of bar length
            MomentJoint1X = [0 1 (0.866) (0.5) 0 (-0.5) (-0.866) (-1) (-0.866) (-0.5) 0 (0.5) (0.866) 1] * momentjoint1scale;
            ...
            %Einbinden in die structure
            AddJoint(momentjoint1_pos, 1, 0, 1)
            end
   ...
   methods (Access = private)
       ...
       function ImplementButtonpushed(app)
        ...
        if app.ButtonPunkt.Value == true
            ...
            if any(app.ForceNNmEditField.Value == 0) || isempty(app.ForceNNmEditField.Value)
               ...
               %Graphische Darstellung
                ...
                text(app.UIAxes,Arrow2XRotated(1),Arrow2YRotated(1),"F = "+ app.ForceNNmEditField.Value + " N",'Fontsize',15,'Color','r');   % name arrow2
                grid(app.UIAxes,'on')
                axis(app.UIAxes,'equal')
                axis(app.UIAxes,'padded')
        ...
        if app.ButtonMoment.Value == true
            ...
            moment1_sign = app.ForceNNmEditField.Value;
            ...
            text(app.UIAxes, Moment1XRotated(1),Moment1YRotated(1),strcat("M = ", num2str(app.ForceNNmEditField.Value), " Nm"),'Fontsize',15,'Color',"green");   % name moment1
            grid(app.UIAxes,'on')
            axis(app.UIAxes,'equal')
            axis(app.UIAxes,'padded')
   ...
   methods (Access = private)
       ...
       function ImplementButtonpushed3(app)
        ...
        %Streckenlast
        % define constshape1
        constshape1scale = (app.barlengthmEditField.Value/2); %(1 / bar1length * (constshape1_endpos - constshape1_startpos));    % size of the shape = 1/10 of bar length 
        constshape1direction = sign(app.pitchkEditField.Value);   % 1 or -1 sign(x)
        constshape1_startheight = sign(app.StartheightEditField.Value);
        ...
        ConstShape1YRotated = ConstShape1Rotated(2,:) * constshape1scale * (1 / app.barlengthmEditField.Value * (constshape1_endpos - constshape1_startpos));
        plot(app.UIAxes, ConstShape1XRotated(2:14),ConstShape1YRotated(2:14),'LineWidth',2,'Color',"blue");   % plot constshape1
        text(app.UIAxes, ConstShape1XRotated(1),ConstShape1YRotated(1),strcat("q = ", num2str(app.StartheightEditField.Value),"+", num2str(app.pitchkEditField.Value), '*x^{' , num2str(constshape1exponent) , '}'," N/m" ),'Fontsize',15,'Color',"blue");   % name constshape1
   ...
   methods (Access = private)
       ...
       function HelpCallback(~)
            ...
            run('Help.m'); % Run the Helpwin script
       end

       function AboutCallback(~)

            run('About.m'); % Run the Helpwin script
       end
