classdef Eingabe_skript < matlab.apps.AppBase
    ...
    methods (Access = public)
        ...
        function createComponents(app)
            ...
            app.PositionmEditField_2Label.Text = '[Position] m2';
            ...
            app.ImplementButton_2.Text = 'Implement2';
            ...
            app.ImplementButton_3.Text = 'Implement3';
 ...
 % Callbacks that handle component events
   ...
   methods (Access = private)
       ...
       function ImplementButtonpushed(app)
        ...
        if app.ButtonMoment.Value == true
            ...
            %text(app.UIAxes, Moment1XRotated(1),Moment1YRotated(1),'M','Fontsize',15,'Color',"green");   % name moment1
            grid(app.UIAxes,'on')
            axis(app.UIAxes,'equal')
            axis(app.UIAxes,'padded')
   ...
   methods (Access = private)
       ...
       function ImplementButtonpushed3(app)
        ...
        constshape1_startheight = app.StartheightEditField.Value;
        ...
        %5text(app.UIAxes, ConstShape1XRotated(1),ConstShape1YRotated(1),'q','Fontsize',15,'Color',"blue");   % name constshape1
        grid(app.UIAxes,'on')
        axis(app.UIAxes,'equal')
        axis(app.UIAxes,'padded')
